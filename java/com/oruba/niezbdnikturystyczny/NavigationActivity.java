...
public class NavigationActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        hills.add(new NavigationItem("Babia Góra", 1723, R.drawable.babia, 49.573333, 19.529444, "Najwyższy szczyt masywu Babiej Góry w Paśmie Babiogórskim należącym do Beskidu Żywieckiego. W masywie Babiej Góry wyróżniono wiele wierzchołków, aby więc sprecyzować, o który dokładnie z nich chodzi, dla najwyższego używa się odrębnej nazwy Diablak."));
