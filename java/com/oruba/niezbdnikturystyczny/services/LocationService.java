package com.oruba.niezbdnikturystyczny.services;
...
import com.oruba.niezbdnikturystyczny.MapsActivity;
...
public class LocationService extends Service {
    ...
    private MapsActivity mMapsActivity = new MapsActivity();
    ...
    private void getMarkers(){
        ...
        handler.postDelayed(new Runnable(){
            public void run(){
                Log.d(TAG, "run: MAKING SERVICE WITH DELAY");
                mMapsActivity.getEventsFromDB();
